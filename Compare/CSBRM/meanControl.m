function [xbar, V, Mcost, N, Xbar] = meanControl(startp, endp, param)

scale = param.scale;

% Initial mean
xbar0 = [startp(1:2) / scale; startp(3:4)];

% Target mean
xbarf = [endp(1:2) / scale; endp(3:4)];

% Final time
% Choose average velocity velavg = 2 m/s
velavg = param.velavg;
